...
attr = ["1138", "1224", "4039", "4720", "7920", "11143", "27770", "34546", "81306", "82168", "265214", "281903", "325729", "415641", "875713"]
...
# v1 = np.random.randint(15, size=15)
# v2 = np.random.randint(15, size=15)
# v3 = np.random.randint(15, size=15)
# v4 = np.random.randint(15, size=15)
# v5 = np.random.randint(15, size=15)

line = Line("折线图示例")
line.add("gpu", attr, v1, is_label_show=True)
line.add("cpu", attr, v2, is_label_show=True)
line.add("yifan hu", attr, v3, is_smooth=False)
line.add("openord", attr, v4, is_smooth=False)
line.add("FA2", attr, v5, is_smooth=False)
line.render()
